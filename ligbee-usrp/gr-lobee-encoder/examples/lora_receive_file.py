...
# Generated: Tue Mar 16 10:16:13 2021
##################################################
...
class lora_receive_file(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.lora_message_file_sink_0_0 = lora.message_file_sink('/home/wangzhe/sjtu/USRP/RPP0/gr-lora/data/rec_file.pcap')
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/wangzhe/sjtu/USRP/RPP0/gr-lora-samples/00_crcoff_cr4_sf7.cfile', True)

        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.lora_lora_receiver_0, 'frames'), (self.lora_message_file_sink_0_0, 'in'))
