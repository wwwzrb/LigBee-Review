...
# Title: Rpp0 Decoder Usrp
# Generated: Tue Mar 23 18:58:55 2021
##################################################
...
class rpp0_decoder_usrp(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Rpp0 Decoder Usrp")
        ...
        self.lora_lora_decoder_0 = lora.lora_decoder(samp_rate, target_freq, bw, sf, False, 4, True, False, False, False, "/home/wangzhe/sjtu/USRP/RPP0/gr-lobee-encoder/")

        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.lora_lora_decoder_0, 'frames'), (self.lora_message_socket_sink_0, 'in'))
        self.connect((self.uhd_usrp_source_0, 0), (self.lora_lora_decoder_0, 0))
    ...
    def set_sf(self, sf):
        self.sf = sf
        self.lora_lora_decoder_0.set_sf(self.sf)
...
def main(top_block_cls=rpp0_decoder_usrp, options=None):
