...
# Title: Rpp0 Lorabee Usrp
# Generated: Tue Mar 23 19:03:45 2021
##################################################
...
class rpp0_lorabee_usrp(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Rpp0 Lorabee Usrp")
        ...
        self.rx_gain = rx_gain = 1000
        self.noise_pow = noise_pow = 0
        self.downlink = downlink = False
        self.decimation = decimation = 1
        self.capture_freq = capture_freq = 868.08e6
        self.bw = bw = 500000
        ...
        self.lora_lobee_receiver_0 = lora.lobee_receiver(samp_rate/decimation, bw, sf, False, 4, True, False, False,4,7,"/home/wangzhe/sjtu/USRP/RPP0/gr-lobee-encoder/")
        self.lobee_quad_to_byte_fb_0 = lobee.quad_to_byte_fb()
        self.digital_clock_recovery_mm_xx_0 = digital.clock_recovery_mm_ff(decimation, 0.000225, 0.5, 0.03, 0.0002)
        ...
        self.connect((self.digital_clock_recovery_mm_xx_0, 0), (self.lobee_quad_to_byte_fb_0, 0))
        self.connect((self.lobee_quad_to_byte_fb_0, 0), (self.lora_lobee_receiver_0, 0))
...
def main(top_block_cls=rpp0_lorabee_usrp, options=None):
