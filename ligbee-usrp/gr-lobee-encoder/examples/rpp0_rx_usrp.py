...
# Title: Rpp0 Rx Usrp
# Generated: Tue Mar 23 19:19:58 2021
##################################################
...
class rpp0_rx_usrp(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Rpp0 Rx Usrp")
        ...
        self.target_freq = target_freq = target_freq_rn2483
        self.sf = sf = 7
        ...
        self.lora_lora_receiver_0 = lora.lora_receiver(samp_rate, target_freq, ([target_freq]), bw, sf, False, 1, False, False, downlink, decimation, True, False, "/home/wangzhe/sjtu/USRP/RPP0/gr-lobee-encoder/")
    ...
    def set_target_freq_rn2483(self, target_freq_rn2483):
        ...
        self.set_target_freq(self.target_freq_rn2483)
...
def main(top_block_cls=rpp0_rx_usrp, options=None):
