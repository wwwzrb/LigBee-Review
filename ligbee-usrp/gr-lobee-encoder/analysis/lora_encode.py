...
if __name__ == "__main__":
    ...
    # test_packet = np.array([0x4, 0x80, 0xf0,0x21, 0x43, 0x65, 0x87], np.uint8)
    test_packet = np.array([0x07, 0x80, 0x00,  0x21, 0x43, 0x65, 0x87,  0x21, 0x43, 0x65], np.uint8)
    # test_packet = np.array([0x07, 0x80, 0x00, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD], np.uint8)
    # test_packet = np.array([0x07, 0x80, 0x00, 0x10, 0x32, 0x54, 0x76, 0x98, 0xBA, 0xDC], np.uint8)
